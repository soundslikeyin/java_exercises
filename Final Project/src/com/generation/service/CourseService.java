...
public class CourseService
{
    ...
    public CourseService()
    {
        ...
        moduleWebFundamentals.addPrerequisite(module);
    ...
    public List<Course> getCoursesOfModule(String moduleCode) {

        List<Course> allCourses = this.getCourses();
        List<Course> coursesOfModule = new ArrayList<>();

        for (Course course: allCourses) {
            if (course.getModule().getCode().equals(moduleCode)) {
                coursesOfModule.add(course);
            }
        }
        return coursesOfModule;
}

    public List<Student> getStudents(String courseCode) {
        return new ArrayList<Student>(enrolledStudents.get(courseCode));
    }
